...
PAGE_MARKERS = {
    ...
    "cn.html": ['id="cn-quote"', 'id="cn-trend"', 'id="cn-capital"', 'id="cn-retail"', 'id="cn-tech"', 'id="cn-fund"', "CN Macro Window"],
    ...
    "research.html": ['id="factor-lab-block"', "Candidate Factor Lab", "./index.html"],
